...
//SearchBar function that expects a prop passed by App called onSearch (which is setSearchedCity)
//TS part.
// { onSearch } : destructuring the prop from App "onSearch={setSearchedCity} "so we can use it 
// Our prop expects a parameter "city" and that parameter MUST Be a string and returns nothing
